    ...
    return Scaffold(
      ...
      body: Column(
        ...
        children: <Widget>[
          ...
          Expanded(
            child: _isLoading ? ShimmerGenerate() : VideosGenerate(),
          ),
        ],
      ),
    );
...
class RecommendTile extends StatelessWidget {
  const RecommendTile({Key? key}) : super(key: key);
...
class ShimmerRecommendTile extends StatelessWidget {
  const ShimmerRecommendTile({Key? key}) : super(key: key);
...
class ChannelName extends StatelessWidget {
  const ChannelName({Key? key}) : super(key: key);
...
class ShimmerChannelName extends StatelessWidget {
  const ShimmerChannelName({Key? key}) : super(key: key);
